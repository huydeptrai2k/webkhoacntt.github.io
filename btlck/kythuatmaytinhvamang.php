...
<html lang="en">
  ...
  <main class="container">
       <div class="row">
            <div class="col-md-12">
                   <div class="duong-dan">
                        <a href="index.php">Khoa công nghệ thông tin</a> > <a href="kythuatmaytinhvamang.php">Kỹ thuật máy tính và mạng</a> 
                    </div>
                    <div class="main-content d-flex">
                        <div class="content-cnpm">
                             <h4><strong>Giới thiệu Bộ môn Kỹ thuật máy tính và mạng</strong></h4>
                             <h6><strong>Bộ môn Kỹ thuật máy tính và mạng đảm nhiệm chức năng giảng dạy tin đại cương, môn tin cơ sở và chuyên ngành kỹ thuật máy tính.</strong></h6>
                             <h6><strong>Thành phần lãnh đạo bộ môn:</strong></h6>
                             <h6><strong> Phó Trưởng bộ môn: Ths Phạm Thanh Bình</strong></h6>
                             <h6>Tốt nghiệp Đại học Bách Khoa năm 2000</h6>
                             <h6>Thạc sỹ  năm 2006  tại ĐH Đại học Bách Khoa Hà Nội</h6>
