...
<div class="admin-content">
    <div class="button-group">
        ...
        <a href="quanlythongbao.php" class="btn btn-big">QL thông báo</a>
    </div>
    <div class="content">
        <h2 class="page-title">Quản lý thông báo</h2>
        <form action="vietbai-process.php" method="post" >
            <div>
                <label>Title</label>
                <input type="text" name="txtTitle" id="txtTitle" class="text-input">
            ...
            <div>
                ...
                <select name="topic" class="text-input">
                    ...
                    <option value=" thongbao"> seminar</option>
                </select>
            </div>
            <div class="button-group">
